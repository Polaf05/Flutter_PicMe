  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Card(
        ...
        elevation: 5.0,
        child: Container(
          decoration: BoxDecoration(color:Color.fromRGBO(43,43,43,1.0)),
          child: ListTile(
        contentPadding: EdgeInsets.fromLTRB(20, 30, 20, 30),
          ...
          title: Text(
            lens.name,
            style: TextStyle(color: Color.fromRGBO(237,237,237,1.0),fontSize: 25.0, fontWeight: FontWeight.bold),
          ),
          subtitle: Row(
            children: <Widget>[
              Icon(Icons.email_outlined, color: Color.fromRGBO(216,181,58,1.0)),
              Text(lens.email, style: TextStyle(color: Color.fromRGBO(237,237,237,1.0)))
            ],
          ),
          trailing:
